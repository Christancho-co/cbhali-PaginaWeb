export default function Footer() {
  return (
    <footer>
      ...
      <nav className="foot__nav foot__nav--a only-d">
        <a href="/">Home</a>
        <a href="/collections">Collections</a>
        <a href="/custom">Custom</a>
        <a href="/contract">Contract</a>
      </nav>
      <nav className="foot__nav foot__nav--b only-d">
        <a href="/about">About Us</a>
        <a href="/blog">Blog &amp; Inspiration</a>
        <a href="/contact">Contact &amp; Dealers</a>
      </nav>

      <img className="foot__social only-d" src="/svg/icons-social.svg" alt="YouTube, LinkedIn, Instagram and Facebook" />

      <img className="foot__mono-m only-m" src="/svg/logo-mark-black.svg" alt="CB Hali" />
      <nav className="foot__nav-m only-m">
        <a className="is-current" href="/">Home</a>
        <a href="/collections">Collections</a>
        <a href="/custom">Custom</a>
        <a href="/contract">Contract</a>
        <a href="/about">About Us</a>
      ...
      <img className="foot__social-m only-m" src="/svg/icons-social-mobile.svg" alt="YouTube, LinkedIn, Instagram and Facebook" />

      <p className="foot__legal">
        Product catalog - Terms &amp; Conditions - Comercial Terms - Care &amp; maintenance -
        Partner Program
      </p>
      <p className="foot__rights only-m">© 2026 CB HALI. All Rights Reserved.</p>
